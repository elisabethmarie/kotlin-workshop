...
class Task(val id: Long, val description: String, val priority: Int, val completed: Boolean = false )
...
fun completedTask(): Task {
    return Task(100, "Buy milk", 1, true)
}
...
fun comparable(t1: Task, t2: Task): Int {
    when (t1.priority > t2.priority) {
        true -> return t1.compareTo(2)
    }
}
